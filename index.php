            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 mr-auto text-center">
                        ...
                        <a class="d-block" <a href="https://wa.me/918139802492?text=Hi,%20Hello.%20I%20Just%20Visited%20Your%20Website!" target="_blank"<i class="fa fa-whatsapp"></i></a><?php echo $_SESSION['system']['email'] ?>"><?php echo $_SESSION['system']['email'] ?></a>
                    </div>
                </div>
            </div>
            <br>
            <div class="container"><div class="small text-center text-muted">Copyright © 2022 - <?php echo $_SESSION['system']['name'] ?> | <a href="http://www.mkhan.ml/" target="_blank">muzammilkhan</a></div></div>
        </footer>
